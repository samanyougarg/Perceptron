...
class NeuralNetwork():
	def __init__(self):
		...
		#values every time the program runs
		random.seed(1)
	...
	# We pass the weighted sum of the inputs to this function 
	...
	def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
		for iteration in xrange(number_of_training_iterations):
			...
			#Calculate the error (Difference between the desired output
...
if __name__ == "__main__":
	...
	# training set
	# 4 examples each consisting of 3 input values and 
	# 1 output value
